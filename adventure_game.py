...
if __name__ == "__main__":
    while True:
        ...
        selection = input(
            "You are in a cursed desert. Will you [Rest], [Explore], [Eat], [Scavenge], [Dungeon], [Upgrade], or [Quit]? ").lower()
        ...
        if selection == "rest":
            ...
            if confirm == "yes":
                ...
                if event == 1:
                    ...
                    if roll == 1:
                        ...
                        bolas += found_bolas
                        print(
                            f"You found a golden sarcophagus ! +{found_bolas} bolas.")
                    elif roll == 3:
                        damage = 20
                        health -= damage
            ...
            if bolas >= 20 and scraps >= 2:
                ...
                print(
                    f"Not enough resources ! Need 20 bolas & 2 scraps. You have: {bolas}B, {scraps}S")
